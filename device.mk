...
# Boot animation
TARGET_SCREEN_HEIGHT := 2368
TARGET_SCREEN_WIDTH := 1728

# Camera
PRODUCT_PACKAGES += \
    android.hardware.camera.provider@2.4-service \
    android.hardware.camera.provider@2.4-impl-sprd:32
...
# Radio
PRODUCT_COPY_FILES += \
    device/jingpad/jade/configs/permissions/privapp-permissions-com.spreadtrum.ims.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapp-permissions-com.spreadtrum.ims.xml
...
PRODUCT_COPY_FILES += \
    device/jingpad/jade/configs/wifi/wpa_supplicant_overlay.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wpa_supplicant_overlay.conf
